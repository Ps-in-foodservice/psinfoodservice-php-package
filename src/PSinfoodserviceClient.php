...
class PSinfoodserviceClient
{
    ...
    /**
     * SSL verification for HTTPS: true (default), false (insecure), or path to a CA bundle PEM file
     *
     * @var bool|string
     */
    private bool|string $verifySSL;
     ...
     * @param bool|string $verifySSL true to use system defaults, false to disable verification (dev only),
     *                               or a string path to a CA bundle PEM (recommended on Windows if cURL error 60)
